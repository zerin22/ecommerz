        ...
        <div class="d-flex">
            ...
            <div class="main-header-center ms-3 d-none d-lg-block">
                <input type="text" class="form-control" id="typehead"
                    placeholder="Search for resultsbackend.">
                            ...
                            <div class="dropdown d-lg-none d-flex">
                                ...
                                <div class="dropdown-menu header-search dropdown-menu-start">
                                    <div class="input-group w-100 p-2">
                                        <input type="text" class="form-control" placeholder="Searchbackendbackend">
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('backend/assets/images/pngs/4.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('backend/assets/images/pngs/6.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('backend/assets/images/pngs/8.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('backend/assets/images/pngs/1.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('backend/assets/images/pngs/3.jpg') }}"></span>
                                            <div class="wd-50p">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            ...
                                            <div class="wd-90p">
                                                ...
                                                <span>Commented on file Guest listbackendbackend</span>
                                            </div>
                                        </a>
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                            ...
                                            <div class="wd-90p">
                                                ...
                                                <span>New Meetup Startedbackendbackendbackend</span>
                                            </div>
                                        </a>
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                            ...
                                            <div class="wd-90p">
                                                ...
                                                <span>Brizid is in the Warehousebackend.</span>
                                            </div>
                                        </a>
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="backend/assets/images/users/4.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                                ...
                                                <span>New Product Realeasebackendbackendbackend</span>
                                            </div>
                                        </a>
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="backend/assets/images/users/3.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                                ...
                                                <span>You have appointment onbackendbackendbackend</span>
                                            </div>
                                        </a>
